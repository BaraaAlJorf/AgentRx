...
python agent_main.py \
    ...
    --train_data_path "/data/user/MedAgent/datasets/multimodal_dataset_splits/train.jsonl" \
    --val_data_path "/data/user/MedAgent/datasets/multimodal_dataset_splits/val.jsonl" \
    --mimic_notes_dir "scratch/baj321/MIMIC-Note/physionet.org/files/mimic-iv-note/2.2/note/" \
    --modalities "ps-ehr-cxr-rr" \
    --agent_setup "MajorityVote" \
    --calibrate_majority_vote "True" \
    --model_id "Qwen/Qwen2.5-VL-7B-Instruct" \
    --output_dir "./results/ablations/calibrate/mv-ps-ehr-cxr-rr/0.000001" \
    --batch_size 3 \
    --lr 0.000001
    --num_shots 2 \
    --refine_iterations 1 \
