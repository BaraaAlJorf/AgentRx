...
python agent_main.py \
    ...
    --output_dir "./results/final_qwen/agenticds-full/no_mmrules_sandwich/train10/llm" \
    --rulebook_dir "/scratch/baj321/MedAgent/results/final_qwen/agenticds-full/New/train10/llm" \
    --batch_size 3 \
    --num_shots 2 \
    --refine_iterations 1 \
    --debate_rounds 3 \
