...
python agent_main.py \
    ...
    --modalities "ps-ehr-rr-cxr" \
    --agent_setup "AgentiCDS" \
    --model_id "Qwen/Qwen2.5-VL-7B-Instruct" \
    --output_dir "./results/final_qwen/agenticds-full/no_mmrules_sandwich/train100/llm" \
    --rulebook_dir "/scratch/baj321/MedAgent/results/final_qwen/agenticds-full/New/train100/llm" \
    --batch_size 3 \
    --num_shots 2 \
    --refine_iterations 1 \
    --debate_rounds 3 \
