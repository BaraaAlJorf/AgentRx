...
python agent_main.py \
    ...
    --train_data_path "/scratch/baj321/MedAgent/datasets/multimodal_dataset_splits/val.jsonl" \
    --mimic_notes_dir "/scratch/baj321/MIMIC-Note/physionet.org/files/mimic-iv-note/2.2/note/" \
    --rulebook_dir "/scratch/baj321/MedAgent/scripts/Unimodal/Qwen/rules" \
    --modalities "ps" \
    --agent_setup "AgentiCDS" \
    --model_id "Qwen/Qwen2.5-VL-7B-Instruct" \
    --output_dir "./results/final_qwen/agenticds-ps" \
    --batch_size 5 \
    --num_shots 2 \
    --refine_iterations 1 \
    --debate_rounds 3 \
